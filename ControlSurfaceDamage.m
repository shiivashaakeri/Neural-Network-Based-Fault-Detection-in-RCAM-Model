function XDOT = ControlSurfaceDamage(X, U, surfaceType, damageSeverity)
...
% Example for aileron damage
if strcmp(surfaceType, 'aileron')
    U(1) = U(1) * (1 - damageSeverity); % Reduced effectiveness or jammed position
elseif strcmp(surfaceType, 'elevator')
    U(2) = U(2) * (1 - damageSeverity); % Reduced effectiveness
elseif strcmp(surfaceType, 'rudder')
    U(3) = U(3) * (1 - damageSeverity); % Reduced effectiveness
end
